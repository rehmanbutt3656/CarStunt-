...
public class RCC_UIDashboardDisplay : MonoBehaviour {
	...
	public bool _showDashboard, _testButtons, _customItems;
	...
	public static RCC_UIDashboardDisplay rccDisplay;
	...
	void Update(){
		...
		case DisplayType.Full:
			...
			if(topButtons && !topButtons.activeInHierarchy && _testButtons)
				topButtons.SetActive(true);

			if(controllerButtons && !controllerButtons.activeInHierarchy)
				//controllerButtons.SetActive(true);

			if(gauges && !gauges.activeInHierarchy && _showDashboard)
				gauges.SetActive(true);

			if(customizationMenu && customizationMenu.activeInHierarchy && _customItems)
