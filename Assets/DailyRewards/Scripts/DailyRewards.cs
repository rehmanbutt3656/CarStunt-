...
namespace NiobiumStudios
{
    ...
    **/
    public class DailyRewards : DailyRewardsCore<DailyRewards>
    {
        ...
        public static DailyRewards dr_Instance;
        ...
        public void ClaimPrize()
        {
            if (availableReward > 0)
            {
                ...
                MainMenuController.Instance.awakeCallforDailyRewards = false;
                MainMenuController.Instance.AvailableCashtxtMainMenu.text = PlayerPrefs.GetInt("AvailableCash").ToString();
